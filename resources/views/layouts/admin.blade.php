...
<body class="sidebar-mini" style="height: auto;">
    <div class="wrapper" id="app">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('first.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('second.index') }}" class="nav-link">
                            <i class="fas fa-bell nav-icon"></i>
                            <p>Second Result</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('common.index') }}" class="nav-link">
                            <i class="fas fa-bell nav-icon"></i>
                            <p>Common Number</p>
                            </a>
                        </li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright © 2014-2019 <a href="https://adminlte.io">Admin</a>.</strong> All rights reserved.
        </footer>
